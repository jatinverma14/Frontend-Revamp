...
export default function PlaylistCard({
  ...
  var temp = (completed / total) * 100
  if (temp % 1 === 0) temp = Number(temp).toFixed(0)
  else temp = Number(temp).toFixed(2)
  const [percentage] = useState(temp)
  return (
    <div style={cardStyles}>
      ...
      >
        <div style={{ paddingTop: '1.3rem', minWidth: '20px' }}>
